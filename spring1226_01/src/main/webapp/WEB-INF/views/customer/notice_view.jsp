	...
	<div id="allwrap">
		<div id="wrap">
			...
			<div id="header">
				...
				<div id="snbBox">
					<h1>
						<a href="/"><img src="../images/txt/logo.gif"
							alt="JARDIN SHOP" /></a>
					</h1>
					<div id="quickmenu">
						<div id="mnaviOpen">
						...
						<div id="customer">
							...
							<div class="viewDivMt">
								<div class="viewHead">
									...
									<div class="day">
										<p class="txt">
											작성일<span><fmt:formatDate value="${map.bdto.bdate}"
							...
							<div class="replyWrite">
								<ul>
									<li class="in">
										<p class="txt">
											총 <span class="orange">${map.list.size()}</span> 개의 댓글이
											달려있습니다.
										</p>
										<p class="password">
									...
									<li class="btn"><a class="replyBtn"
										style="cursor: pointer;">등록</a></li>
								</ul>
