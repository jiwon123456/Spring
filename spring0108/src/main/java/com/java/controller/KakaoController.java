...
public class KakaoController {
	...
	public String oauth(String code) {
		//****code 값가져오기
		//code 값 받기
		System.out.println("kaokao code : "+code);
		...
		String client_id = "37d5d0cf6e2fb80102fa2eb8a4155093";
	    ...
	    //json 데이터를 java오브젝트로 변경
		try {
			oAuthToken = objectMapper.readValue(response.getBody(), OAuthToken.class);
		} catch (Exception e) {e.printStackTrace();}
		
		System.out.println("카카오 토큰키 : "+response);
		System.out.println("카카오 토큰키 getBodu : "+response.getBody());
		...
		System.out.println("카카오사용자정보 kaKaoDto nickname : "+kaKaoDto.getProperties().getNickname());
