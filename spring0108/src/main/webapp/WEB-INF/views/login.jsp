...
<body>
  ...
  <section>
    ...
    <ul class="login-icons">
      <li class="phone"></li>
      <a href="https://kauth.kakao.com/oauth/authorize?client_id=37d5d0cf6e2fb80102fa2eb8a4155093&redirect_uri=http://localhost:8000/kakao/oauth&response_type=code">
      <li class="kakao"></li>
      </a>
      <li class="naver"></li>
