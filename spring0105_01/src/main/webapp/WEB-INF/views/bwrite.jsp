  ...
  <script>
  	...
  	function uploadImage(file,this_location){ //매개변수 - file:이미지파일,현재위치값
  		...
  		$.ajax({
			...
			contentType:false, //파일을 보내는 형태 default값 : (contentType을 안할경우 default 값)application/x-www.-form-urlencoded
  ...
  <section>
    ...
    <form action="bwrite" name="writeFrm" method="post" enctype="multipart/form-data">
      ...
      <div class="button-wrapper">
        <button type="submit" class="write button" style="cursor: pointer;">작성완료</button>
        <button type="button" class="cancel button" style="cursor: pointer;" onclick="javascript:location.href='blist'">취소</button>
      </div>
    </form>
